        ...
        <div class="email-body">
            <div class="container">
                <div class="email-text">
                    <h2 class="hd">Your Feedback Matters</h2>

                    <div class="customer-text mb-4">
                        Thank you for participating in the {{$maildata['workshop']}} on {{ date('m/d/Y h:i A',$maildata['date'])}}. We
                        ask that you take this <a href="{{$maildata['link']}} ">short survey</a> to help us understand what
                        you took away from the experience.
                    </div>

                    <div class="customer-text mb-4">
                        In addition, here are a few reminders of things you can do coming out of the
                        workshop to be a change maker:
                    </div>
                    ...
                    <div class="customer-text mb-4">
                        Practice implementing tips you learned everyday. Small changes go a long
                        way.
                    </div>
