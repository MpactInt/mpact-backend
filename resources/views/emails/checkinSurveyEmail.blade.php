        ...
        <div class="email-body">
            <div class="container">
                <div class="email-text">
                    <h2 class="hd">Tell Us How You Feel…</h2>

                    <div class="customer-text mb-4">
                        Take less than a minute to tell us how you feel as you think about the upcoming week.
                    </div>

                    <div class="mb-4">
                        <a class=" btn btn-primary" href="{{$maildata['link']}}">Tell us here!</a>
                    </div>
                    <div class="customer-text mb-4">
                        Need to share more. Contact your customer support team.
                    </div>
                    <div class="customer-text mb-4">
                        This email was automatically generated. If you have any questions contact your customer support team. 
                    </div>
                </div>
            </div>
        </div>
